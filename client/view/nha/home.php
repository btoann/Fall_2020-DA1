            ...
            <div class="row-container-product">
                <div class="banner-item">
                    <div class="banner-left">
                        <img class="song" src="../../../.public/images/akalibanner.jpg" alt="" />
                    </div>
                    <div class="banner-right">
                        <div class="slideshow-container">
                            ...
                            <div class="mySlides fade">
                                <img src="../../../.public/images/banner4.jpg" style="width: 100%" />
                            </div>
                        </div>
    ...
    <div class="row-container-product">
        <div class="row-sale">
            <div class="title-sale">
                <span><strong>GIÁ SỐC TRONG NGÀY<i class="icon-fire-2"></i></strong></span>
            </div>
            <div class="time">
                <p id="dongho"></p>
            </div>
                ...
                <a href="#">
                    <div class="product">
                        ...
                        <div class="product-information">
                            <p>
                                <a class="product-link" href="#"><strong>Điện thoại iphone...</strong></a>
                            </p>
...
<div class="block">
    ...
    <a rel="noreferrer" href="https://tiki.vn/gioi-thieu-ve-tiki" class="small-text" target="_blank">Giới thiệu
        ...
        href="https://tiki.vn/chuong-trinh/ban-hang-doanh-nghiep" class="small-text" target="_blank">Bán hàng doanh
        nghiệp</a>
</div>
<div class="block">
    ...
    <a rel="noreferrer" href="https://tiki.vn/quy-che-hoat-dong-sgdtmdt" class="small-text" target="_blank">Quy chế hoạt
        ...
        target="_blank">Bán hàng cùng sidebyside</a>
</div>
<div class="block">

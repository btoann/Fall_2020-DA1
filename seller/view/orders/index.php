<div class="center">
    <div class="center__content">
        ...
        <p class="center__desc">Xem đơn hàng</p>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td data-label="Thanh toán" class="center__confirm">
                                <a href="" class="center__iconTable"><img src="assets/icon-check.svg" alt=""></a>
                                <a href="" class="center__iconTable"><img src="assets/icon-x.svg" alt=""></a>
                            </td>
                        </tr>
                        <tr>
                            <td data-label="STT">1</td>
                            ...
                            <td data-label="Thanh toán">
                                <a href="" class="center__iconTable iconConfirm"><img src="assets/icon-check.svg" alt=""></a>
                                <a href="" class="center__iconTable iconConfirm"><img src="assets/icon-x.svg" alt=""></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
